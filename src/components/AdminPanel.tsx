...
export function AdminPanel({ products, setProducts, slides, setSlides, onClose, socialLinks = {instagram:"", x:"", facebook:""}, setSocialLinks, isMainAdmin = false }: AdminPanelProps) {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'products' | 'slides' | 'sync_history' | 'settings' | 'notifications' | 'subadmins' | 'support'>('dashboard');
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-black tracking-tight text-black capitalize">
              {activeTab === 'products' ? 'Products Catalog' : activeTab === 'sync_history' ? 'Sync Activity Log' : activeTab === 'notifications' ? 'Send Notifications' : activeTab === 'support' ? 'Support Messages' : activeTab}
            </h2>
          </div>
