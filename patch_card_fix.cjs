...
const targetIcons = `<div className="flex items-center gap-1">
...
const replacementIcons = `<div className="flex items-center gap-2">
...
const targetInputs = `{paymentMethod === 'card' && (
...
const replacementInputs = `{paymentMethod === 'card' && (
